...
**Announce at start:** "I'm using harness-creator to analyze and build harness infrastructure for this project."
...
**Required sub-skill:** Use `harness-creator:harness-analyze`
...
**Required sub-skill:** Use `harness-creator:harness-guide`
...
**Required sub-skill:** Use `harness-creator:harness-apply`
